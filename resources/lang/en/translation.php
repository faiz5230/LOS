<?php
return [
    "account_officers"=>"Account Officers",
    "data_master"=>"Data Master",
    "users"=>"Users",
    "analisa_kredit"=>"Analisa Kredit",
    "debiturs"=>"Data Debitur",
    "simulations"=>"Simulasi Kredit",
    "multiguna_pegawai"=>"Multiguna Pegawai",
    "simulasi_kredit"=>"Simulasi Kredit",
    "data_debitur"=>"Data Debitur",
    "persiapan_kredit"=>"Persiapan Kredit",
    "modal_kerja"=>"Modal Kerja",
    "pensiun"=>"Pensiun",
    "pasar"=>"Pasar",
    "umkm"=>"UMKM",
    "simulasi_modal_kerja"=>"Simulasi Modal Kerja",
    "data_debitur_modal_kerja"=>"Data Debitur Modal Kerja",
    "simulasi_pensiun"=>"Simulasi Pensiun",
    "data_debitur_pensiun"=>"Data Debitur Pensiun",
    "simulasi_pasar"=>"Simulasi Pasar",
    "data_debitur_pasar"=>"Data Debitur Pasar",
    "simulasi_umkm"=>"Simulasi UMKM",
    "data_debitur_umkm"=>"Data Debitur UMKM",
    "analisa_kredit_modal_kerja"=>"Analisa Kredit Modal Kerja",
    "analisa_yuridis_modal_kerja"=>"Analisa Yuridis Modal Kerja",
    "analisa_kredit_pensiun"=>"Analisa Kredit Pensiun",
    "analisa_yuridis_pensiun"=>"Analisa Yuridis Pensiun",
    "analisa_kredit_pasar"=>"Analisa Kredit Pasar",
    "analisa_yuridis_pasar"=>"Analisa Yuridis Pasar",
    "analisa_kredit_umkm"=>"Analisa Kredit UMKM",
    "analisa_yuridis_umkm"=>"Analisa Yuridis UMKM",
    "analisa_yuridis"=>"Analisa Yuridis",
    "menu"=>"Menu",
