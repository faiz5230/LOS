<table>
    ...
    <tr>
        <td colspan="2">Nama Usaha</td>
        <td>:</td>
        <td colspan="3">{{ $debitur->nama_usaha ?? '' }}</td>
        <td colspan="3"></td>
    </tr>
    ...
    <tr>
        ...
        <td>:</td>
        <td colspan="3">{{ $debitur->alamat_usaha ?? '' }}</td>
        <td colspan="3"></td>
    </tr>
    ...
    <tr>
        ...
        <td>:</td>
        <td colspan="3">{{ $debitur->lama_usaha ?? '' }}</td>
        <td colspan="3"></td>
    </tr>
    ...
    <tr>
        ...
        <td>:</td>
        <td colspan="3">{{ $debitur->no_telepon_pemohon ?? '' }}</td>
        <td colspan="3"></td>
    </tr>
