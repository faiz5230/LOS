...
<table>
    ...
    <tr>
        ...
        <td colspan="8" style="border:1px solid #000;">
            {{ $debitur->tanggal ? \Carbon\Carbon::parse($debitur->tanggal)->translatedFormat('d F Y') : '' }}
        </td>
        <td colspan="5" style="border:1px solid #000;"></td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="1" style="border:1px solid #000;text-align:center;">:</td>
        <td colspan="8" style="border:1px solid #000;">{{ $debitur->account_officer ?? '' }}</td>
        <td colspan="5" style="border:1px solid #000;"></td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="1" style="border:1px solid #000;text-align:center;">:</td>
        <td colspan="8" style="border:1px solid #000;">{{ $memoNomor }}</td>
    ...
    <tr>
        ...
        <td colspan="1" style="border:1px solid #000;text-align:center;">:</td>
        <td colspan="7" style="border:1px solid #000;">{{ $debitur->nama_pensiun ?? '' }}</td>
    ...
    <tr>
        ...
        <td colspan="2" style="border:1px solid #000;background:#d9d9d9;font-size:18px;font-weight:bold;text-align:center;">
            {{ number_format($debitur->jumlah_permohonan_kredit ?? 0,0,',','.') }}
        </td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="5" style="border:1px solid #000;font-weight:bold;">
            {{ strtoupper(terbilang($debitur->jumlah_permohonan_kredit ?? 0)) }} RUPIAH
        </td>
    </tr>
    ...
    <tr>
        ...
        <td colspan="1" style="border:1px solid #000;text-align:center;">:</td>
        <td colspan="3" style="border:1px solid #000;text-align:center;">{{ $debitur->jangka_waktu ?? '' }}</td>
    ...
    <tr>
        ...
        <td colspan="1" style="border:1px solid #000;">Rp.</td>
        <td colspan="4" style="border:1px solid #000;text-align:right;">
            {{ number_format($debitur->simulation->biaya_asuransi ?? 0,0,',','.') }}
        </td>
    ...
    {{-- =======================
       BAGIAN BAWAH (TANDA TANGAN + DROPPING)
    ======================= --}}
    <tr>
    ...
    {{-- Baris tanda tangan dan PI INST --}}
    <tr>
    ...
    <tr>
        <td colspan="4" style="border:1px solid #000;text-align:center;">{{ $debitur->account_officer ?? '' }}</td>
