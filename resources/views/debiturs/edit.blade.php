...
@section('css')
    <link href="{{ URL::asset('css/select2.min.css',$simulation->tanggal_lahir) }}" rel="stylesheet" />
@endsection
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="pull-right mb-2">
                        <a class="btn btn-success" href="{{ route($route . '.index',$simulation->tanggal_lahir) }}"> <i data-feather="arrow-left"></i>
                            Kembali</a>
                    </div>
                    <div class="live-preview">
                        ...
                        <form action="{{ route($route . '.update',$simulation->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <input type="hidden" name="id_simulation" id="id_simulation" value={{$simulations->id}} />
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="card">
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                ...
                                                                <select name="jenis_kelamin" id="jenis_kelamin"
                                                                    class="form-control form-control-sm" required>
                                                                    <option value="Laki-laki" {{ $simulation->jenis_kelamin == 'Laki-laki' ? 'selected' : '' }}>Laki-laki</option>
                                                                    <option value="Perempuan" {{ $simulation->jenis_kelamin == 'Perempuan' ? 'selected' : '' }}>Perempuan</option>
                                                                </select>
                                                                @error('jenis_kelamin')
                                                                    <div class="alert alert-danger mt-1 mb-1">
                                                                        {{ $message }}
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                ...
                                                                <input type="text"
                                                                    value="{{ old('pendidikan_terakhir',$simulation->pendidikan_terakhir) }}"
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">Status Perkawinan
                                                                    <span style="color:red">*</span></span>
                                                                <input type="text"
                                                                    value="{{ old('status_perkawinan',$simulation->status_perkawinan) }}"
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">Nama Ibu Kandung <span
                                                                        style="color:red">*</span></span>
                                                                <input type="text"
                                                                    value="{{ old('nama_ibu_kandung',$simulation->nama_ibu_kandung) }}"
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">Pekerjaan Ibu Kandung
                                                                    <span style="color:red">*</span></span>
                                                                <input type="text"
                                                                    value="{{ old('pekerjaan_ibu_kandung',$simulation->pekerjaan_ibu_kandung) }}"
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">Nama Ayah Kandung
                                                                    <span style="color:red">*</span></span>
                                                                <input type="text"
                                                                    value="{{ old('nama_ayah_kandung',$simulation->nama_ayah_kandung) }}"
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">Pekerjaan Ayah Kandung
                                                                    <span style="color:red">*</span></span>
                                                                <input type="text"
                                                                    value="{{ old('pekerjaan_ayah_kandung',$simulation->pekerjaan_ayah_kandung) }}"
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">No Telepon Pemohon
                                                                    <span style="color:red">*</span></span>
                                                                <input type="text"
                                                                    value="{{ old('no_telepon_pemohon',$simulation->no_telepon_pemohon) }}"
                                                                ...
                                                                <div class="form-group">
                                                                     <div class="input-group input-group-sm">
                                                                        <span class="input-group-text col-4">No Ijasah
                                                                            <span style="color:red">*</span></span>
                                                                        <input type="text"
                                                                            value="{{ old('no_ijasah',$simulation->no_ijasah) }}"
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                                <div class="form-group">
                                                                     <div class="input-group input-group-sm">
                                                                        ...
                                                                        <input type="text"
                                                                            value="{{ old('nama_pasangan',$simulation->nama_pasangan) }}"
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                                <div class="form-group">
                                                                     <div class="input-group input-group-sm">
                                                                        ...
                                                                        <input type="number" value="{{ old('no_ktp_sim_pasangan',$simulation->no_ktp_sim_pasangan) }}"
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                                <div class="form-group">
                                                                     <div class="input-group input-group-sm">
                                                                        ...
                                                                        <input type="text"
                                                                            value="{{ old('tempat_lahir_pasangan',$simulation->tempat_lahir_pasangan) }}"
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                                <div class="form-group">
                                                                     <div class="input-group input-group-sm">
                                                                        ...
                                                                        <input type="date"
                                                                            value="{{ old('tanggal_lahir_pasangan',$simulation->tanggal_lahir_pasangan) }}"
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                                <div class="form-group">
                                                                     <div class="input-group input-group-sm">
                                                                        ...
                                                                        <input type="number"
                                                                            value="{{ old('jumlah_tanggungan',$simulation->jumlah_tanggungan) }}"
                                                                ...
                                                                <div class="form-group">
                                                                     <div class="input-group input-group-sm">
                                                                        <span class="input-group-text col-4">Pekerjaan
                                                                            Pasangan </span>
                                                                        <input type="text"
                                                                            value="{{ old('pekerjaan_pasangan',$simulation->pekerjaan_pasangan) }}"
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                                <div class="form-group">
                                                                     <div class="input-group input-group-sm">
                                                                        ...
                                                                        <input type="text"
                                                                            value="{{ old('nama_perusahaan_pasangan',$simulation->nama_perusahaan_pasangan) }}"
                                                                ...
                                                                <div class="form-group">
                                                                     <div class="input-group input-group-sm">
                                                                        ...
                                                                        <textarea name="alamat_perusahaan_pasangan" id="alamat_perusahaan_pasangan" class="form-control form-control-sm"
                                                                            required>{{ old('alamat_perusahaan',$simulation->alamat_perusahaan) }}</textarea>
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                                <div class="form-group">
                                                                     <div class="input-group input-group-sm">
                                                                        ...
                                                                        <input type="text"
                                                                            value="{{ old('lama_bekerja_pasangan',$simulation->lama_bekerja_pasangan) }}"
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                                <div class="form-group">
                                                                     <div class="input-group input-group-sm">
                                                                        ...
                                                                        <input type="text"
                                                                            value="{{ old('no_telepon_pasangan',$simulation->no_telepon_pasangan) }}"
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">Nama Kontak Tidak
                                                                    ...
                                                                    <span style="color:red">*</span></span>
                                                                <input type="text"
                                                                    value="{{ old('nama_kontak_tidak_serumah',$simulation->nama_kontak_tidak_serumah) }}"
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">No Telepon
                                                                    <span style="color:red">*</span></span>
                                                                <input type="text"
                                                                    value="{{ old('no_telepon_kontak_tidak_serumah',$simulation->no_telepon_kontak_tidak_serumah) }}"
                                                            ...
                                                            <div class="form-group">
                                                                 <div class="input-group input-group-sm">
                                                                    <span class="input-group-text col-4">Nama
                                                                        ...
                                                                        <span style="color:red">*</span></span>
                                                                    <input type="text"
                                                                        value="{{ old('nama_perusahaan',$simulation->nama_perusahaan) }}"
                                                            ...
                                                            <div class="form-group">
                                                                 <div class="input-group input-group-sm">
                                                                    <span class="input-group-text col-4">Lama Bekerja
                                                                        <span style="color:red">*</span></span>
                                                                    <input type="text"
                                                                        value="{{ old('lama_bekerja',$simulation->lama_bekerja) }}"
                                                            ...
                                                            <div class="form-group">
                                                                 <div class="input-group input-group-sm">
                                                                    <span class="input-group-text col-4">No ID Pegawai
                                                                        <span style="color:red">*</span></span>
                                                                    <input type="text"
                                                                        value="{{ old('no_id_pegawai',$simulation->no_id_pegawai) }}"
                                                            ...
                                                            <div class="form-group">
                                                                 <div class="input-group input-group-sm">
                                                                    <span class="input-group-text col-4">Bidang Usaha
                                                                        <span style="color:red">*</span></span>
                                                                    <input type="text"
                                                                        value="{{ old('bidang_usaha',$simulation->bidang_usaha) }}"
                                                            ...
                                                            <div class="form-group">
                                                                 <div class="input-group input-group-sm">
                                                                    <span class="input-group-text col-4">Jumlah Permohonan
                                                                        ...
                                                                        <span style="color:red">*</span></span>
                                                                    <input type="text"
                                                                        value="{{ old('jumlah_permohonan_kredit', convertNumberFormat($simulation->jumlah_permohonan_kredit)) }}"
                                                            ...
                                                            <div class="form-group">
                                                                 <div class="input-group input-group-sm">
                                                                    <span class="input-group-text col-4">Tujuan Penggunaan
                                                                        <span style="color:red">*</span></span>
                                                                    <input type="text"
                                                                        value="{{ old('tujuan_penggunaan',$simulation->tanggal_lahir) }}"
                                                                    ...
                                                                    <span class="input-group-text col-4">Account Officer
                                                                        ...
                                                                        <select name="account_officer" id="account_officer" class="form-control form-control-sm" required>
                                                                            ...
                                                                            @foreach ($accountOfficers as $accountOfficer)
                                                                                <option value="{{ $accountOfficer->nama }}" {{ $simulation->account_officer == $accountOfficer->nama ? 'selected' : '' }}>{{ $accountOfficer->nama }}</option>
                                                                            @endforeach
                                                                        </select>
...
@section('script')
    <script src="{{ URL::asset('build/js/jquery-3.6.0.min.js',$simulation->tanggal_lahir) }}"></script>

    <script src="{{ URL::asset('build/libs/cleave.js/cleave.min.js',$simulation->tanggal_lahir) }}"></script>
    <script src="{{ URL::asset('build/js/select2.min.js',$simulation->tanggal_lahir) }}"></script>

    <script src="{{ URL::asset('build/js/app.js',$simulation->tanggal_lahir) }}"></script>
    <script>
