        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Edit Data Debitur Pensiun</h4>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        ...
                        <form action="{{ route('debitur-pensiun.update', $debitur->id) }}" method="POST">
    @csrf
    @method('PUT')
                                ...
                                <div class="form-group">
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input type="text" name="nama_pensiun" class="form-control"
                                            value="{{ old('nama_pensiun', $debitur->nama_pensiun) }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                <div class="form-group">
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input type="text" name="atas_nama_agunan" class="form-control"
                                            value="{{ old('nama_pensiun', $debitur->nama_pensiun) }}">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input type="text" name="nama_perusahaan" class="form-control"
                                            value="{{ old('nama_perusahaan', $debitur->nama_perusahaan) }}">
                                    </div>
                                </div>
                            </div>
                        </div>
