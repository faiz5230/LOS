            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="pull-right mb-2">
                        ...
                        <a href="{{ route('debitur-modal-kerja.export.memo_kredit', $debitur->id) }}" class="btn btn-primary">
                        <i class="fas fa-download"></i> Memo Droping</a>
                        <a href="{{ route('debitur-modal-kerja.export.sppk', $debitur->id) }}"
                           class="btn btn-primary"><i class="fas fa-download"></i> Export SPPK     
                        </a>
                        <a href="{{ route('debitur-modal-kerja.export.sttu', $debitur->id) }}"
                           class="btn btn-primary"><i class="fas fa-download"></i> Export STTU   
                        </a>
                        <a href="{{ route('debitur-modal-kerja.export.pk_snd_sim', $debitur->id) }}"
                           class="btn btn-primary"><i class="fas fa-download"></i> PK Sendiri   
                        </a>
                        <a href="{{ route('debitur-modal-kerja.export.pk_kredit_pasangan', $debitur->id) }}"
                           class="btn btn-primary"><i class="fas fa-download"></i> PK Pasangan   
                        </a>
                        <a href="{{ route('debitur-modal-kerja.export.surat_kuasa', $debitur->id) }}"
                           class="btn btn-primary"><i class="fas fa-download"></i> Surat Kuasa  
                        </a>
                        <a href="{{ route('debitur-modal-kerja.export.surat_askep', $debitur->id) }}"
                           class="btn btn-primary"><i class="fas fa-download"></i> Surat Askep
                        </a>
                        <a href="{{ route('debitur-modal-kerja.export.pk_kredit_perusahaan', $debitur->id) }}"
                        ...
                        <a href="{{ route('debitur-modal-kerja.export.memo_fasilitas_kredit', $debitur->id) }}"
                           class="btn btn-primary"><i class="fas fa-download"></i> Memo Fasilitas Kredit
                        </a>
                        <a href="{{ route('debitur-modal-kerja.export.mcc', $debitur->id) }}"
                           class="btn btn-primary"><i class="fas fa-download"></i> MCC
                        </a>
                        <a href="{{ route('debitur-modal-kerja.export.tanda_terima', $debitur->id) }}"
