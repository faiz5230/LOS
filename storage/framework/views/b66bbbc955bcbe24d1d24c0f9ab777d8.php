...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                        <div class="form-group">
                                                            ...
                                                            ?>
                                                            <select id="jenis_kredit" name="<?php echo e(!empty($jenis_kredit) ? 'jenis_kredit_display' : 'jenis_kredit'); ?>" class="form-control" <?php echo e(!empty($jenis_kredit) ? 'disabled' : ''); ?>>
                                                                ...
                                                                <?php else: ?>
                                                                    ...
                                                                    <option value="Modal Kerja" <?php echo e($selected_jenis_kredit == 'Modal Kerja' ? 'selected' : ''); ?>>Modal Kerja</option>
                                                                    <option value="Pensiun" <?php echo e($selected_jenis_kredit == 'Pensiun' ? 'selected' : ''); ?>>Pensiun</option>
                                                                    <option value="Pasar" <?php echo e($selected_jenis_kredit == 'Pasar' ? 'selected' : ''); ?>>Pasar</option>
                                                                    <option value="UMKM" <?php echo e($selected_jenis_kredit == 'UMKM' ? 'selected' : ''); ?>>UMKM</option>
                                                                <?php endif; ?>
                                                            </select>
                                                            <?php if(!empty($jenis_kredit)): ?>
