...
<div class="auth-page-wrapper pt-5">
    <!-- auth page bg -->
    <div class="auth-one-bg-position auth-one-bg" style="background: linear-gradient(90deg,#edebeb,#0cc4bd) !important" id="auth-particles">
        <div class=""></div>
                    ...
                    <div class="text-center mt-sm-5 mb-4 text-white-50">
                        <div>
                            <a href="index" class="d-inline-block auth-logo">
                                <img src="<?php echo e(URL::asset('build/images/logo.webp')); ?>" alt="" height="100">
                            </a>
                        </div>
                        <p class="mt-3 fs-22 fw-semibold text-white">SISTEM APLIKASI KREDIT</p>
                    </div>
                </div>
            </div>
            <!-- end row -->
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\BWS\Project\Los\LOS\resources\views/auth/login.blade.php ENDPATH**/ ?>