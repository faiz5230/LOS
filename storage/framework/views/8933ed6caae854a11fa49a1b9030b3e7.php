...
<?php $__env->startSection('css'); ?>
    <link href="<?php echo e(URL::asset('css/select2.min.css',$simulation->tanggal_lahir)); ?>" rel="stylesheet" />
<?php $__env->stopSection(); ?>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="pull-right mb-2">
                        <a class="btn btn-success" href="<?php echo e(route($route . '.index',$simulation->tanggal_lahir)); ?>"> <i data-feather="arrow-left"></i>
                            Kembali</a>
                    </div>
                    <div class="live-preview">
                        ...
                        <form action="<?php echo e(route($route . '.update',$simulation->id)); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="id_simulation" id="id_simulation" value=<?php echo e($simulations->id); ?> />
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="card">
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                ...
                                                                <select name="jenis_kelamin" id="jenis_kelamin"
                                                                    class="form-control form-control-sm" required>
                                                                    <option value="Laki-laki" <?php echo e($simulation->jenis_kelamin == 'Laki-laki' ? 'selected' : ''); ?>>Laki-laki</option>
                                                                    <option value="Perempuan" <?php echo e($simulation->jenis_kelamin == 'Perempuan' ? 'selected' : ''); ?>>Perempuan</option>
                                                                </select>
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">No KTP/SIM <span
                                                                        style="color:red">*</span></span>
                                                                <input type="number" value="<?php echo e(old('no_ktp_sim',$simulation->no_ktp_sim)); ?>"
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">Masa Berlaku <span
                                                                        style="color:red">*</span></span>
                                                                <input type="date" value="<?php echo e(old('masa_berlaku',$simulation->masa_berlaku)); ?>"
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">Alamat Lengkap <span
                                                                        style="color:red">*</span></span>
                                                                <textarea name="alamat_lengkap" id="alamat_lengkap" class="form-control form-control-sm" required><?php echo e(old('alamat_lengkap',$simulation->alamat_lengkap)); ?></textarea>
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">Tempat Lahir <span
                                                                        style="color:red">*</span></span>
                                                                <input type="text" value="<?php echo e(old('tempat_lahir',$simulation->tempat_lahir)); ?>"
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                ...
                                                                <input type="text"
                                                                    value="<?php echo e(old('pendidikan_terakhir',$simulation->pendidikan_terakhir)); ?>"
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">Status Rumah <span
                                                                        style="color:red">*</span></span>
                                                                <input type="text" value="<?php echo e(old('status_rumah',$simulation->status_rumah)); ?>"
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">Lama Menempati <span
                                                                        style="color:red">*</span></span>
                                                                <input type="text" value="<?php echo e(old('lama_menempati',$simulation->lama_menempati)); ?>"
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">Status Perkawinan
                                                                    <span style="color:red">*</span></span>
                                                                <input type="text"
                                                                    value="<?php echo e(old('status_perkawinan',$simulation->status_perkawinan)); ?>"
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">Nama Ibu Kandung <span
                                                                        style="color:red">*</span></span>
                                                                <input type="text"
                                                                    value="<?php echo e(old('nama_ibu_kandung',$simulation->nama_ibu_kandung)); ?>"
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">Pekerjaan Ibu Kandung
                                                                    <span style="color:red">*</span></span>
                                                                <input type="text"
                                                                    value="<?php echo e(old('pekerjaan_ibu_kandung',$simulation->pekerjaan_ibu_kandung)); ?>"
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">Nama Ayah Kandung
                                                                    <span style="color:red">*</span></span>
                                                                <input type="text"
                                                                    value="<?php echo e(old('nama_ayah_kandung',$simulation->nama_ayah_kandung)); ?>"
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">Pekerjaan Ayah Kandung
                                                                    <span style="color:red">*</span></span>
                                                                <input type="text"
                                                                    value="<?php echo e(old('pekerjaan_ayah_kandung',$simulation->pekerjaan_ayah_kandung)); ?>"
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">No Telepon Pemohon
                                                                    <span style="color:red">*</span></span>
                                                                <input type="text"
                                                                    value="<?php echo e(old('no_telepon_pemohon',$simulation->no_telepon_pemohon)); ?>"
                                                                ...
                                                                <div class="form-group">
                                                                     <div class="input-group input-group-sm">
                                                                        <span class="input-group-text col-4">Agunan <span
                                                                                style="color:red">*</span></span>
                                                                        <input type="text" value="<?php echo e(old('agunan',$simulation->agunan)); ?>"
                                                                ...
                                                                <div class="form-group">
                                                                     <div class="input-group input-group-sm">
                                                                        <span class="input-group-text col-4">No Ijasah
                                                                            <span style="color:red">*</span></span>
                                                                        <input type="text"
                                                                            value="<?php echo e(old('no_ijasah',$simulation->no_ijasah)); ?>"
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                                <div class="form-group">
                                                                     <div class="input-group input-group-sm">
                                                                        ...
                                                                        <input type="text"
                                                                            value="<?php echo e(old('nama_pasangan',$simulation->nama_pasangan)); ?>"
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                                <div class="form-group">
                                                                     <div class="input-group input-group-sm">
                                                                        ...
                                                                        <input type="number" value="<?php echo e(old('no_ktp_sim_pasangan',$simulation->no_ktp_sim_pasangan)); ?>"
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                                <div class="form-group">
                                                                     <div class="input-group input-group-sm">
                                                                        ...
                                                                        <input type="text"
                                                                            value="<?php echo e(old('tempat_lahir_pasangan',$simulation->tempat_lahir_pasangan)); ?>"
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                                <div class="form-group">
                                                                     <div class="input-group input-group-sm">
                                                                        ...
                                                                        <input type="date"
                                                                            value="<?php echo e(old('tanggal_lahir_pasangan',$simulation->tanggal_lahir_pasangan)); ?>"
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                                <div class="form-group">
                                                                     <div class="input-group input-group-sm">
                                                                        ...
                                                                        <input type="number"
                                                                            value="<?php echo e(old('jumlah_tanggungan',$simulation->jumlah_tanggungan)); ?>"
                                                                ...
                                                                <div class="form-group">
                                                                     <div class="input-group input-group-sm">
                                                                        <span class="input-group-text col-4">Pekerjaan
                                                                            Pasangan </span>
                                                                        <input type="text"
                                                                            value="<?php echo e(old('pekerjaan_pasangan',$simulation->pekerjaan_pasangan)); ?>"
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                                <div class="form-group">
                                                                     <div class="input-group input-group-sm">
                                                                        ...
                                                                        <input type="text"
                                                                            value="<?php echo e(old('nama_perusahaan_pasangan',$simulation->nama_perusahaan_pasangan)); ?>"
                                                                ...
                                                                <div class="form-group">
                                                                     <div class="input-group input-group-sm">
                                                                        ...
                                                                        <textarea name="alamat_perusahaan_pasangan" id="alamat_perusahaan_pasangan" class="form-control form-control-sm"
                                                                            required><?php echo e(old('alamat_perusahaan',$simulation->alamat_perusahaan)); ?></textarea>
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                                <div class="form-group">
                                                                     <div class="input-group input-group-sm">
                                                                        ...
                                                                        <input type="text"
                                                                            value="<?php echo e(old('lama_bekerja_pasangan',$simulation->lama_bekerja_pasangan)); ?>"
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                                <div class="form-group">
                                                                     <div class="input-group input-group-sm">
                                                                        ...
                                                                        <input type="text"
                                                                            value="<?php echo e(old('no_telepon_pasangan',$simulation->no_telepon_pasangan)); ?>"
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">Nama Kontak Tidak
                                                                    ...
                                                                    <span style="color:red">*</span></span>
                                                                <input type="text"
                                                                    value="<?php echo e(old('nama_kontak_tidak_serumah',$simulation->nama_kontak_tidak_serumah)); ?>"
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">Hubungan <span
                                                                        style="color:red">*</span></span>
                                                                <input type="text" value="<?php echo e(old('hubungan',$simulation->hubungan)); ?>"
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">Alamat <span
                                                                        style="color:red">*</span></span>
                                                                <textarea name="alamat" id="alamat" class="form-control form-control-sm" required><?php echo e(old('alamat',$simulation->alamat)); ?></textarea>
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">No Telepon
                                                                    <span style="color:red">*</span></span>
                                                                <input type="text"
                                                                    value="<?php echo e(old('no_telepon_kontak_tidak_serumah',$simulation->no_telepon_kontak_tidak_serumah)); ?>"
                                                            ...
                                                            <div class="form-group">
                                                                 <div class="input-group input-group-sm">
                                                                    <span class="input-group-text col-4">Nama
                                                                        ...
                                                                        <span style="color:red">*</span></span>
                                                                    <input type="text"
                                                                        value="<?php echo e(old('nama_perusahaan',$simulation->nama_perusahaan)); ?>"
                                                            ...
                                                            <div class="form-group">
                                                                 <div class="input-group input-group-sm">
                                                                    <span class="input-group-text col-4">Alamat
                                                                        Perusahaan
                                                                        <span style="color:red">*</span></span>
                                                                    <textarea name="alamat_perusahaan" id="alamat_perusahaan" class="form-control form-control-sm" required><?php echo e(old('alamat_perusahaan',$simulation->alamat_perusahaan)); ?></textarea>
                                                            ...
                                                            <div class="form-group">
                                                                 <div class="input-group input-group-sm">
                                                                    <span class="input-group-text col-4">Lama Bekerja
                                                                        <span style="color:red">*</span></span>
                                                                    <input type="text"
                                                                        value="<?php echo e(old('lama_bekerja',$simulation->lama_bekerja)); ?>"
                                                            ...
                                                            <div class="form-group">
                                                                 <div class="input-group input-group-sm">
                                                                    <span class="input-group-text col-4">No ID Pegawai
                                                                        <span style="color:red">*</span></span>
                                                                    <input type="text"
                                                                        value="<?php echo e(old('no_id_pegawai',$simulation->no_id_pegawai)); ?>"
                                                            ...
                                                            <div class="form-group">
                                                                 <div class="input-group input-group-sm">
                                                                    <span class="input-group-text col-4">Bidang Usaha
                                                                        <span style="color:red">*</span></span>
                                                                    <input type="text"
                                                                        value="<?php echo e(old('bidang_usaha',$simulation->bidang_usaha)); ?>"
                                                            ...
                                                            <div class="form-group">
                                                                 <div class="input-group input-group-sm">
                                                                    <span class="input-group-text col-4">Jabatan <span
                                                                            style="color:red">*</span></span>
                                                                    <input type="text" value="<?php echo e(old('jabatan',$simulation->jabatan)); ?>"
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                            <div class="form-group">
                                                                 <div class="input-group input-group-sm">
                                                                    <span class="input-group-text col-4">No Telepon
                                                                        <span style="color:red">*</span></span>
                                                                    <input type="text" value="<?php echo e(old('no_telepon',$simulation->no_telepon)); ?>"
                                                            ...
                                                            <div class="form-group">
                                                                 <div class="input-group input-group-sm">
                                                                    <span class="input-group-text col-4">Jumlah Permohonan
                                                                        ...
                                                                        <span style="color:red">*</span></span>
                                                                    <input type="text"
                                                                        value="<?php echo e(old('jumlah_permohonan_kredit', convertNumberFormat($simulation->jumlah_permohonan_kredit))); ?>"
                                                            ...
                                                            <div class="form-group">
                                                                 <div class="input-group input-group-sm">
                                                                    <span class="input-group-text col-4">Tujuan Penggunaan
                                                                        <span style="color:red">*</span></span>
                                                                    <input type="text"
                                                                        value="<?php echo e(old('tujuan_penggunaan',$simulation->tanggal_lahir)); ?>"
                                                                    ...
                                                                    <span class="input-group-text col-4">Account Officer
                                                                        ...
                                                                        <select name="account_officer" id="account_officer" class="form-control form-control-sm" required>
                                                                            ...
                                                                            <?php $__currentLoopData = $accountOfficers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $accountOfficer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <option value="<?php echo e($accountOfficer->nama); ?>" <?php echo e($simulation->account_officer == $accountOfficer->nama ? 'selected' : ''); ?>><?php echo e($accountOfficer->nama); ?></option>
                                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                        </select>
...
<?php $__env->startSection('script'); ?>
    <script src="<?php echo e(URL::asset('build/js/jquery-3.6.0.min.js',$simulation->tanggal_lahir)); ?>"></script>

    <script src="<?php echo e(URL::asset('build/libs/cleave.js/cleave.min.js',$simulation->tanggal_lahir)); ?>"></script>
    <script src="<?php echo e(URL::asset('build/js/select2.min.js',$simulation->tanggal_lahir)); ?>"></script>

    <script src="<?php echo e(URL::asset('build/js/app.js',$simulation->tanggal_lahir)); ?>"></script>
    <script>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\BWS\Project\LOS\LOS\resources\views/debiturs/edit.blade.php ENDPATH**/ ?>