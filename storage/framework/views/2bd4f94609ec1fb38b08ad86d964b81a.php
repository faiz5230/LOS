...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                        <div class="form-group">
                                                            ...
                                                            <option value="UMKM" <?php if($simulation->jenis_kredit == 'UMKM'): echo 'selected'; endif; ?> >UMKM</option>
                                                            <option value="KTA Pegawai" <?php if($simulation->jenis_kredit == 'KTA Pegawai'): echo 'selected'; endif; ?> >KTA Pegawai</option>
                                                            <option value="Modal Kerja" <?php if($simulation->jenis_kredit == 'Modal Kerja'): echo 'selected'; endif; ?> >Modal Kerja</option>
                                                            <option value="Pensiun" <?php if($simulation->jenis_kredit == 'Pensiun'): echo 'selected'; endif; ?> >Pensiun</option>
                                                            </select>
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group input-group-sm">
                                                                <input type="text" value="<?php echo e($dsrValue); ?>"
                                                                    name="dsr" id="dsr"
                                                                    class="form-control form-control-sm">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp8.2\htdocs\LOS\resources\views/simulations/edit.blade.php ENDPATH**/ ?>