    ...
    <div class="col-xl-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a class="btn btn-success" href="<?php echo e(route($route . '.index')); ?>">
                <i data-feather="arrow-left"></i> Kembali
                </a>

                <?php if($simulation->jenis_kredit == 'Modal Kerja'): ?>
                <a class="btn btn-primary" href="<?php echo e(route('debitur-modal-kerja.create', ['simulation' => $simulation->id])); ?>">
                Buat Debitur Modal Kerja
                </a>

                <?php elseif($simulation->jenis_kredit == 'Pensiun'): ?>
                <a class="btn btn-primary" href="<?php echo e(route('debitur-pensiun.create', ['simulation' => $simulation->id])); ?>">
                <i data-feather="plus-square"></i> Buat Data Debitur Pensiun
                 </a>

                <?php elseif($simulation->jenis_kredit == 'Pasar'): ?>
                <a class="btn btn-primary" href="<?php echo e(route('debitur-pasar.create', ['simulation' => $simulation->id])); ?>">
                <i data-feather="plus-square"></i> Buat Data Debitur Pasar
                </a>

                <?php elseif($simulation->jenis_kredit == 'UMKM'): ?>
                
                <a class="btn btn-primary" href="<?php echo e(route('debitur-umkm.create', ['simulation' => $simulation->id])); ?>">
                <i data-feather="plus-square"></i> Buat Data Debitur UMKM
                </a>

                <?php else: ?>
                
                <a class="btn btn-primary" href="<?php echo e(route('debiturs_simulation', [$simulation->id])); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LOS\resources\views/simulations/show.blade.php ENDPATH**/ ?>