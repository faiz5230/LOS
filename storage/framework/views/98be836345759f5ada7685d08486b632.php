                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse menu-dropdown" id="sidebarPensiun">
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                            <a href="<?php echo e(route('debitur-pensiun.index')); ?>" class="nav-link"><?php echo app('translator')->get('translation.data_debitur_pensiun'); ?></a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
...
<?php /**PATH C:\xampp\htdocs\LOS\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>