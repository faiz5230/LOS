...
<?php $__env->startSection('content'); ?>
    <?php $__env->startComponent('components.breadcrumb'); ?>
        ...
        <?php $__env->slot('title'); ?>
            Tambah Simulasi <?php echo e($jenis_kredit ?? ''); ?>

        <?php $__env->endSlot(); ?>
    <?php echo $__env->renderComponent(); ?>

    <form action="<?php echo e(route($route . '.store')); ?>" method="POST" id="simulationForm">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                    value="<?php echo e(old('tanggal_realisasi')); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <?php if(!empty($jenis_kredit)): ?>
                                        <option value="<?php echo e($jenis_kredit); ?>" selected><?php echo e($jenis_kredit); ?></option>
                                    <?php else: ?>
...
unset($__errorArgs, $__bag); ?>" 
                                    value="<?php echo e(old('jatuh_tempo')); ?>" readonly>
...
unset($__errorArgs, $__bag); ?>" 
                                    value="<?php echo e(old('usia')); ?>" readonly>
...
unset($__errorArgs, $__bag); ?>" 
                                        value="<?php echo e(old('besaran_gaji')); ?>" placeholder="0">
...
unset($__errorArgs, $__bag); ?>" 
                                        value="<?php echo e(old('maksimal_angsuran')); ?>" readonly>
...
unset($__errorArgs, $__bag); ?>" 
                                        value="<?php echo e(old('plafond')); ?>" placeholder="0">
...
unset($__errorArgs, $__bag); ?>" 
                                        value="<?php echo e(old('bunga_flat')); ?>" placeholder="0">
                                    <span class="input-group-text">%</span>
...
unset($__errorArgs, $__bag); ?>" 
                                        value="<?php echo e(old('bunga_effektif')); ?>" readonly>
                                    <span class="input-group-text">%</span>
...
unset($__errorArgs, $__bag); ?>" 
                                        value="<?php echo e(old('angsuran')); ?>" readonly>
...
unset($__errorArgs, $__bag); ?>" 
                                        value="<?php echo e(old('sisa_gaji')); ?>" readonly>
...
unset($__errorArgs, $__bag); ?>" 
                                        value="<?php echo e(old('biaya_provisi')); ?>" readonly>
...
unset($__errorArgs, $__bag); ?>" 
                                        value="<?php echo e(old('biaya_notaris')); ?>">
...
unset($__errorArgs, $__bag); ?>" 
                                        value="<?php echo e(old('biaya_administrasi')); ?>" readonly>
...
unset($__errorArgs, $__bag); ?>" 
                                        value="<?php echo e(old('biaya_asuransi')); ?>" readonly>
...
unset($__errorArgs, $__bag); ?>" 
                                        value="<?php echo e(old('biaya_materai')); ?>" readonly>
...
unset($__errorArgs, $__bag); ?>" 
                                        value="<?php echo e(old('tabungan_wajib')); ?>" readonly>
...
unset($__errorArgs, $__bag); ?>" 
                                    value="<?php echo e(old('rate_asuransi')); ?>" readonly>
...
unset($__errorArgs, $__bag); ?>" 
                                        value="<?php echo e(old('ass_krd')); ?>" readonly>
...
unset($__errorArgs, $__bag); ?>" 
                                        value="<?php echo e(old('total_diterima')); ?>" readonly style="font-size: 1.5rem; font-weight: 600;">
