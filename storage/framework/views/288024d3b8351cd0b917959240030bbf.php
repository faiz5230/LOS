    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        <div class="form-group">
            <div class="input-group input-group-sm">
                ...
                <input type="text" name="nama_pasangan" class="form-control" value="<?php echo e(old('nama_pasangan')); ?>">
            </div>
        </div>
    </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
        <div class="form-group">
            <div class="input-group input-group-sm">
                ...
                <input type="text" name="nik_pasangan" class="form-control" value="<?php echo e(old('nik_pasangan')); ?>">
            </div>
        </div>
    </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
        <div class="form-group">
            <div class="input-group input-group-sm">
                ...
                <input type="text" name="pekerjaan_pasangan" class="form-control" value="<?php echo e(old('pekerjaan_pasangan')); ?>">
            </div>
        </div>
    </div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
        <div class="form-group">
            <div class="input-group input-group-sm">
                ...
                <input type="text" name="alamat_pasangan" class="form-control" value="<?php echo e(old('alamat_pasangan')); ?>">
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LOS\resources\views/debitur-modal-kerja/edit.blade.php ENDPATH**/ ?>