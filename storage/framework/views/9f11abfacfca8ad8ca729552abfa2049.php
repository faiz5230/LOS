                ...
                <div class="card-body">
                    ...
                    <div class="row mb-2">
                        <div class="col-12 mb-3">
                            <?php if($debitur->simulation): ?>
                                <h5>Dokumen Export - <?php echo e($debitur->simulation->jenis_kredit); ?></h5>
                            <?php else: ?>
                        ...
                        <div class="col-6">
                            ...
                            <a class="btn btn-primary mb-2" href="<?php echo e(route('debiturs_pk_kredit_sendiri_export', $debitur->id)); ?>">
                                PK Kredit Sendiri</a>
                            <a class="btn btn-primary mb-2" href="<?php echo e(route('debiturs_pk_kredit_non_mou_pasangan_export', $debitur->id)); ?>">
                                PK Kredit Non MOU Pasangan</a>
                            <a class="btn btn-primary mb-2" href="<?php echo e(route('debiturs_pk_kredit_non_mou_sendiri_export', $debitur->id)); ?>">
