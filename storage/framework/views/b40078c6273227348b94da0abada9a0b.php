            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="pull-right mb-2">
                        <a class="btn btn-success" href="<?php echo e(route('simulations.index', ['jenis_kredit' => 'UMKM'])); ?>">
                    ...
                    <div class="live-preview">
                        ...
                        <form action="<?php echo e(route('debitur-umkm.store')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="input-group input-group-sm">
                                                                ...
                                                                <select name="jenis_kelamin" id="jenis_kelamin" class="form-control form-control-sm" required>
                                                                    <option value="Laki-laki" <?php echo e(old('jenis_kelamin', $simulation->jenis_kelamin) == 'Laki-laki' ? 'selected' : ''); ?>>Laki-laki</option>
                                                                    <option value="Perempuan" <?php echo e(old('jenis_kelamin', $simulation->jenis_kelamin) == 'Perempuan' ? 'selected' : ''); ?>>Perempuan</option>
                                                                </select>
                                                            </div>
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                        <div class="form-group">
                                                            <div class="input-group input-group-sm">
                                                                ...
                                                                <input type="text" value="<?php echo e(old('pendidikan_terakhir', $simulation->pendidikan_terakhir)); ?>"
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                        <div class="form-group">
                                                            <div class="input-group input-group-sm">
                                                                ...
                                                                <input type="text" value="<?php echo e(old('status_perkawinan', $simulation->status_perkawinan)); ?>"
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                        <div class="form-group">
                                                            <div class="input-group input-group-sm">
                                                                ...
                                                                <input type="text" value="<?php echo e(old('nama_ibu_kandung', $simulation->nama_ibu_kandung)); ?>"
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                        <div class="form-group">
                                                            <div class="input-group input-group-sm">
                                                                ...
                                                                <input type="text" value="<?php echo e(old('pekerjaan_ibu_kandung', $simulation->pekerjaan_ibu_kandung)); ?>"
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                        <div class="form-group">
                                                            <div class="input-group input-group-sm">
                                                                ...
                                                                <input type="text" value="<?php echo e(old('nama_ayah_kandung', $simulation->nama_ayah_kandung)); ?>"
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                        <div class="form-group">
                                                            <div class="input-group input-group-sm">
                                                                ...
                                                                <input type="text" value="<?php echo e(old('pekerjaan_ayah_kandung', $simulation->pekerjaan_ayah_kandung)); ?>"
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                        <div class="form-group">
                                                            <div class="input-group input-group-sm">
                                                                ...
                                                                <input type="text" value="<?php echo e(old('no_telepon_pemohon', $simulation->no_telepon_pemohon)); ?>"
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                                <div class="form-group">
                                                                    <div class="input-group input-group-sm">
                                                                        ...
                                                                        <input type="text" value="<?php echo e(old('no_ijasah', $simulation->no_ijasah)); ?>"
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                                <div class="form-group">
                                                                    <div class="input-group input-group-sm">
                                                                        ...
                                                                        <input type="text" value="<?php echo e(old('nama_pasangan', $simulation->nama_pasangan)); ?>"
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="input-group input-group-sm">
                                                                        ...
                                                                        <textarea name="alamat_perusahaan_pasangan" id="alamat_perusahaan_pasangan"
                                                                            class="form-control form-control-sm" required><?php echo e(old('alamat_perusahaan_pasangan', $simulation->alamat_perusahaan_pasangan)); ?></textarea>
                                                                    </div>
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                        <div class="form-group">
                                                            <div class="input-group input-group-sm">
                                                                ...
                                                                <input type="text" value="<?php echo e(old('nama_kontak_tidak_serumah', $simulation->nama_kontak_tidak_serumah)); ?>"
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                        <div class="form-group">
                                                            <div class="input-group input-group-sm">
                                                                ...
                                                                <textarea name="alamat_saudara" id="alamat_saudara" class="form-control form-control-sm"><?php echo e(old('alamat_saudara', $simulation->alamat_saudara)); ?></textarea>
                                                            </div>
                                                            <?php $__errorArgs = ['alamat_saudara'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                        <div class="form-group">
                                                            <div class="input-group input-group-sm">
                                                                ...
                                                                <input type="text" value="<?php echo e(old('no_telepon_kontak_tidak_serumah', $simulation->no_telepon_kontak_tidak_serumah)); ?>"
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                            <div class="form-group">
                                                                <div class="input-group input-group-sm">
                                                                    ...
                                                                    <input type="text" value="<?php echo e(old('lama_bekerja', $simulation->lama_bekerja)); ?>"
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                            <div class="form-group">
                                                                <div class="input-group input-group-sm">
                                                                    ...
                                                                    <input type="text" value="<?php echo e(old('no_id_pegawai', $simulation->no_id_pegawai)); ?>"
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                            <div class="form-group">
                                                                <div class="input-group input-group-sm">
                                                                    ...
                                                                    <input type="text" value="<?php echo e(old('bidang_usaha', $simulation->bidang_usaha)); ?>"
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                            <div class="form-group">
                                                                <div class="input-group input-group-sm">
                                                                    ...
                                                                    <input type="text" value="<?php echo e(old('jumlah_permohonan_kredit', convertNumberFormat($simulation->plafond))); ?>"
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                            <div class="form-group">
                                                                <div class="input-group input-group-sm">
                                                                    ...
                                                                    <input type="number" value="<?php echo e(old('jangka_waktu', $simulation->jangka_waktu)); ?>"
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                            <div class="form-group">
                                                                <div class="input-group input-group-sm">
                                                                    ...
                                                                    <input type="text" value="<?php echo e(old('tujuan_penggunaan', $simulation->tujuan_penggunaan)); ?>"
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                            <div class="form-group">
                                                                <div class="input-group input-group-sm">
                                                                    ...
                                                                    <input type="text" value="<?php echo e(old('besaran_gaji', convertNumberFormat($simulation->besaran_gaji))); ?>"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LOS\resources\views/debitur-umkm/create.blade.php ENDPATH**/ ?>