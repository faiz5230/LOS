        ...
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Edit Data Debitur UMKM</h4>
                </div><!-- end card header -->
                ...
                <div class="card-body">
                    ...
                    <div class="live-preview">
                        ...
                        <?php endif; ?>
                        <form action="<?php echo e(route('debitur-umkm.update', $debitur->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('PUT'); ?>
                            <input type="hidden" name="simulation_id" value="<?php echo e(old('simulation_id', $debitur->simulation_id)); ?>">
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="card">
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                        <div class="form-group">
                                                            <div class="input-group input-group-sm">
                                                                ...
                                                                <input type="text" value="<?php echo e(old('nama',$debitur->nama)); ?>"
                                                                    name="nama" id="nama"
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                     <div class="form-group">
                                                        ...
                                                        <?php $jk = old('jenis_kelamin', $debitur->jenis_kelamin); ?>
                                                        <option value="Laki-laki" <?php echo e($jk == 'Laki-laki' ? 'selected' : ''); ?>>Laki-laki</option>
                                                        <option value="Perempuan" <?php echo e($jk == 'Perempuan' ? 'selected' : ''); ?>>Perempuan</option>
                                                        </select>
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">No KTP/SIM <span
                                                                        style="color:red">*</span></span>
                                                                <input type="number" value="<?php echo e(old('no_ktp_sim',$debitur->no_ktp_sim)); ?>"
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">Masa Berlaku <span
                                                                        style="color:red">*</span></span>
                                                                <input type="date" value="<?php echo e(old('masa_berlaku',$debitur->masa_berlaku)); ?>"
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">Alamat Lengkap <span
                                                                        style="color:red">*</span></span>
                                                                <textarea name="alamat_lengkap" id="alamat_lengkap" class="form-control form-control-sm" required><?php echo e(old('alamat_lengkap',$debitur->alamat_lengkap)); ?></textarea>
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">Tempat Lahir <span
                                                                        style="color:red">*</span></span>
                                                                <input type="text" value="<?php echo e(old('tempat_lahir',$debitur->tempat_lahir)); ?>"
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">Tanggal Lahir <span
                                                                        style="color:red">*</span></span>
                                                                <input type="date" value="<?php echo e(old('tanggal_lahir',$debitur->tanggal_lahir)); ?>"
                                                    ...
                                                    <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                ...
                                                                <input type="text"
                                                                    value="<?php echo e(old('pendidikan_terakhir',$debitur->pendidikan_terakhir)); ?>"
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">Status Rumah <span
                                                                        style="color:red">*</span></span>
                                                                <input type="text" value="<?php echo e(old('status_rumah',$debitur->status_rumah)); ?>"
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">Lama Menempati <span
                                                                        style="color:red">*</span></span>
                                                                <input type="text" value="<?php echo e(old('lama_menempati',$debitur->lama_menempati)); ?>"
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">Status Perkawinan
                                                                    <span style="color:red">*</span></span>
                                                                <input type="text"
                                                                    value="<?php echo e(old('status_perkawinan',$debitur->status_perkawinan)); ?>"
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">Nama Ibu Kandung <span
                                                                        style="color:red">*</span></span>
                                                                <input type="text"
                                                                    value="<?php echo e(old('nama_ibu_kandung',$debitur->nama_ibu_kandung)); ?>"
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">Pekerjaan Ibu Kandung
                                                                    <span style="color:red">*</span></span>
                                                                <input type="text"
                                                                    value="<?php echo e(old('pekerjaan_ibu_kandung',$debitur->pekerjaan_ibu_kandung)); ?>"
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">Nama Ayah Kandung
                                                                    <span style="color:red">*</span></span>
                                                                <input type="text"
                                                                    value="<?php echo e(old('nama_ayah_kandung',$debitur->nama_ayah_kandung)); ?>"
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">Pekerjaan Ayah Kandung
                                                                    <span style="color:red">*</span></span>
                                                                <input type="text"
                                                                    value="<?php echo e(old('pekerjaan_ayah_kandung',$debitur->pekerjaan_ayah_kandung)); ?>"
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">No Telepon Pemohon
                                                                    <span style="color:red">*</span></span>
                                                                <input type="text"
                                                                    value="<?php echo e(old('no_telepon_pemohon',$debitur->no_telepon_pemohon)); ?>"
                                                                ...
                                                                <div class="form-group">
                                                                     <div class="input-group input-group-sm">
                                                                        <span class="input-group-text col-4">Agunan <span
                                                                                style="color:red">*</span></span>
                                                                        <input type="text" value="<?php echo e(old('agunan',$debitur->agunan)); ?>"
                                                                ...
                                                                <div class="form-group">
                                                                     <div class="input-group input-group-sm">
                                                                        <span class="input-group-text col-4">No Ijasah
                                                                            <span style="color:red">*</span></span>
                                                                        <input type="text"
                                                                            value="<?php echo e(old('no_ijasah',$debitur->no_ijasah)); ?>"
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                                <div class="form-group">
                                                                     <div class="input-group input-group-sm">
                                                                        ...
                                                                        <input type="text"
                                                                            value="<?php echo e(old('nama_pasangan',$debitur->nama_pasangan)); ?>"
...
unset($__errorArgs, $__bag); ?>
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                                <div class="form-group">
                                                                     <div class="input-group input-group-sm">
                                                                        <span class="input-group-text col-4">No KTP/SIM</span>
                                                                        <input type="text" name="no_ktp_sim_pasangan" class="form-control"
                                                                            value="<?php echo e(old('no_ktp_sim_pasangan', $debitur->no_ktp_sim_pasangan)); ?>">
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                                <div class="form-group">
                                                                     <div class="input-group input-group-sm">
                                                                        ...
                                                                        <input type="text"
                                                                            value="<?php echo e(old('tempat_lahir_pasangan',$debitur->tempat_lahir_pasangan)); ?>"
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                                <div class="form-group">
                                                                     <div class="input-group input-group-sm">
                                                                        ...
                                                                        <input type="date"
                                                                            value="<?php echo e(old('tanggal_lahir_pasangan',$debitur->tanggal_lahir_pasangan)); ?>"
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                                <div class="form-group">
                                                                     <div class="input-group input-group-sm">
                                                                        ...
                                                                        <input type="number"
                                                                            value="<?php echo e(old('jumlah_tanggungan',$debitur->jumlah_tanggungan)); ?>"
                                                                ...
                                                                <div class="form-group">
                                                                     <div class="input-group input-group-sm">
                                                                        <span class="input-group-text col-4">Pekerjaan
                                                                            Pasangan </span>
                                                                        <input type="text"
                                                                            value="<?php echo e(old('pekerjaan_pasangan',$debitur->pekerjaan_pasangan)); ?>"
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                                <div class="form-group">
                                                                     <div class="input-group input-group-sm">
                                                                        ...
                                                                        <input type="text"
                                                                            value="<?php echo e(old('nama_perusahaan_pasangan',$debitur->nama_perusahaan_pasangan)); ?>"
                                                                ...
                                                                <div class="form-group">
                                                                     <div class="input-group input-group-sm">
                                                                        ...
                                                                        <textarea name="alamat_perusahaan_pasangan" id="alamat_perusahaan_pasangan" class="form-control form-control-sm"
                                                                            required><?php echo e(old('alamat_perusahaan_pasangan',$debitur->alamat_perusahaan_pasangan)); ?></textarea>
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                                <div class="form-group">
                                                                     <div class="input-group input-group-sm">
                                                                        ...
                                                                        <input type="text"
                                                                            value="<?php echo e(old('lama_bekerja_pasangan',$debitur->lama_bekerja_pasangan)); ?>"
                                                            ...
                                                            <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                                <div class="form-group">
                                                                     <div class="input-group input-group-sm">
                                                                        ...
                                                                        <input type="text"
                                                                            value="<?php echo e(old('no_telepon_pasangan',$debitur->no_telepon_pasangan)); ?>"
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">Nama Kontak Tidak
                                                                    ...
                                                                    <span style="color:red">*</span></span>
                                                                <input type="text"
                                                                    value="<?php echo e(old('nama_kontak_tidak_serumah',$debitur->nama_kontak_tidak_serumah)); ?>"
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">Hubungan <span
                                                                        style="color:red">*</span></span>
                                                                <input type="text" value="<?php echo e(old('hubungan',$debitur->hubungan)); ?>"
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">Alamat <span
                                                                        style="color:red">*</span></span>
                                                                <textarea name="alamat_saudara" id="alamat_saudara" class="form-control form-control-sm" required><?php echo e(old('alamat_saudara',$debitur->alamat_saudara)); ?></textarea>
                                                        ...
                                                        <div class="form-group">
                                                             <div class="input-group input-group-sm">
                                                                <span class="input-group-text col-4">No Telepon
                                                                    <span style="color:red">*</span></span>
                                                                <input type="text"
                                                                    value="<?php echo e(old('no_telepon_kontak_tidak_serumah',$debitur->no_telepon_kontak_tidak_serumah)); ?>"
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="card-header align-items-center d-flex">
                                                <h4 class="card-title mb-0 flex-grow-1">DATA PEKERJAAN CALON DEBITUR UMKM
                                                </h4>
                                            </div><!-- end card header -->
                                            <div class="card-body">
                                                <div class="row">
                                                            ...
                                                            <div class="form-group">
                                                                 <div class="input-group input-group-sm">
                                                                    <span class="input-group-text col-4">Nama
                                                                        ...
                                                                        <span style="color:red">*</span></span>
                                                                    <input type="text"
                                                                        value="<?php echo e(old('nama_usaha',$debitur->nama_usaha)); ?>"
                                                                        name="nama_usah" id="nama_usaha"
                                                                        class="form-control form-control-sm" required>
                                                            ...
                                                            <div class="form-group">
                                                                 <div class="input-group input-group-sm">
                                                                    <span class="input-group-text col-4">Alamat
                                                                        Perusahaan
                                                                        <span style="color:red">*</span></span>
                                                                    <textarea name="alamat_perusahaan" id="alamat_perusahaan" class="form-control form-control-sm" required><?php echo e(old('alamat_perusahaan',$debitur->alamat_perusahaan)); ?></textarea>
                                                            ...
                                                            <div class="form-group">
                                                                 <div class="input-group input-group-sm">
                                                                    <span class="input-group-text col-4">Lama Bekerja
                                                                        <span style="color:red">*</span></span>
                                                                    <input type="text"
                                                                        value="<?php echo e(old('lama_bekerja',$debitur->lama_bekerja)); ?>"
                                                            ...
                                                            <div class="form-group">
                                                                 <div class="input-group input-group-sm">
                                                                    <span class="input-group-text col-4">No ID Pegawai
                                                                        <span style="color:red">*</span></span>
                                                                    <input type="text"
                                                                        value="<?php echo e(old('no_id_pegawai',$debitur->no_id_pegawai)); ?>"
                                                            ...
                                                            <div class="form-group">
                                                                 <div class="input-group input-group-sm">
                                                                    <span class="input-group-text col-4">Bidang Usaha
                                                                        <span style="color:red">*</span></span>
                                                                    <input type="text"
                                                                        value="<?php echo e(old('bidang_usaha',$debitur->bidang_usaha)); ?>"
                                                            ...
                                                            <div class="form-group">
                                                                 <div class="input-group input-group-sm">
                                                                    <span class="input-group-text col-4">Jabatan <span
                                                                            style="color:red">*</span></span>
                                                                    <input type="text" value="<?php echo e(old('jabatan',$debitur->jabatan)); ?>"
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                            <div class="form-group">
                                                                 <div class="input-group input-group-sm">
                                                                    <span class="input-group-text col-4">No Telepon
                                                                        <span style="color:red">*</span></span>
                                                                    <input type="text" value="<?php echo e(old('no_telepon',$debitur->no_telepon)); ?>"
                                                            ...
                                                            <div class="form-group">
                                                                 <div class="input-group input-group-sm">
                                                                    <span class="input-group-text col-4">Jumlah Permohonan
                                                                        ...
                                                                        <span style="color:red">*</span></span>
                                                                    <input type="text"
                                                                        value="<?php echo e(old('jumlah_permohonan_kredit', number_format($debitur->jumlah_permohonan_kredit, 0, ',', '.'))); ?>">
                                                            ...
                                                            <div class="form-group">
                                                                 <div class="input-group input-group-sm">
                                                                    <span class="input-group-text col-4">Jangka Waktu <span
                                                                            style="color:red">*</span></span>
                                                                    <input type="number"
                                                                        value="<?php echo e(old('jangka_waktu', $debitur->jangka_waktu)); ?>"
                                                            ...
                                                            <div class="form-group">
                                                                 <div class="input-group input-group-sm">
                                                                    <span class="input-group-text col-4">Tujuan Penggunaan
                                                                        <span style="color:red">*</span></span>
                                                                    <input type="text"
                                                                        value="<?php echo e(old('tujuan_penggunaan',$debitur->tujuan_penggunaan)); ?>"
                                                                    ...
                                                                    <span class="input-group-text col-4">Account Officer
                                                                        ...
                                                                        <select name="account_officer" id="account_officer" class="form-control form-control-sm" required>
                                                                            ...
                                                                            <?php $__currentLoopData = $accountOfficers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $accountOfficer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <option value="<?php echo e($accountOfficer->nama); ?>" <?php echo e($debitur->account_officer == $accountOfficer->nama ? 'selected' : ''); ?>><?php echo e($accountOfficer->nama); ?></option>
                                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                        </select>
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-12 pt-3">
                                                            <div class="form-group">
                                                                 <div class="input-group input-group-sm">
                                                                    ...
                                                                    <input type="text"
                                                                        value="<?php echo e(old('besaran_gaji', number_format($debitur->besaran_gaji, 0, ',', '.'))); ?>">
                                                            ...
                                                            <div class="form-group">
                                                                 <div class="input-group input-group-sm">
                                                                    <span class="input-group-text col-4">DSR (%)<span
                                                                            style="color:red">*</span></span>
                                                                    <input type="number" value="<?php echo e(old('dsr',$debitur->dsr)); ?>"
                                                                        name="dsr" id="dsr"
                                                                        class="form-control form-control-sm" required> 
                                                            ...
                                                            <div class="form-group">
                                                                 <div class="input-group input-group-sm">
                                                                    <span class="input-group-text col-4">Angsuran <span
                                                                            style="color:red">*</span></span>
                                                                    <input type="text" value="<?php echo e(old('angsuran',convertNumberFormat($debitur->angsuran))); ?>"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LOS\resources\views/debitur-umkm/edit.blade.php ENDPATH**/ ?>