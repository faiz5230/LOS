...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 08, 2026 at 02:46 AM
...
--
-- Table structure for table `analisa_kredit`
--
...
--
-- Dumping data for table `analisa_kredit`
--
...
--
-- Table structure for table `debitur_modal_kerja`
--
...
--
-- Dumping data for table `debitur_modal_kerja`
--

INSERT INTO `debitur_modal_kerja` (`id`, `simulation_id`, `permohonan_kredit`, `tanggal`, `nama_perusahaan`, `bidang_usaha_perusahaan`, `nib`, `akte_pendirian`, `alamat_lengkap`, `no_npwp_perusahaan`, `no_telp_perusahaan`, `agunan`, `no_agunan`, `atas_nama_agunan`, `nama_direktur`, `no_ktp_sim`, `tempat_lahir`, `tanggal_lahir`, `jumlah_tanggungan`, `pekerjaan`, `nama_perusahaan_direktur`, `alamat_perusahaan_direktur`, `lama_bekerja`, `no_telepon_direktur`, `nama_usaha`, `alamat_usaha`, `lama_usaha`, `bentuk_badan_usaha`, `bidang_usaha`, `npwp_usaha`, `no_telepon_usaha`, `jumlah_permohonan_kredit`, `jangka_waktu`, `tujuan_penggunaan`, `account_officer`, `pemohon`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 10, 'Modal Kerja', '2025-11-24', 'bws', 'bws', '4234234', 'sdfasdfasdf', 'Jl. Diponegoro no 28\r\nJl. Diponegoro no 28', '234234', '234234234', 'xxx', 'W-00596061', 'sdfasdf', 'luthfi', '345345345', 'fdgdfgdfg', '1990-11-24', 4, 'dfgdfg', 'dfgdfgdfg', 'dfgdfg', 'dfgdfg', '34534', 'tertet', 'ertert', '4', 'dfgdfgdfg', 'dfgdf', 'dfgdfgdf', 'gdfgdfg', 100000000.00, 24, 'Modal Kerja', 'Muhammad Aria Putra', 'dfgdfg', '2025-11-24 00:09:01', '2025-11-24 00:17:48', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `debitur_pensiun`
--
...
--
-- Dumping data for table `debitur_pensiun`
--

INSERT INTO `debitur_pensiun` (`id`, `tanggal`, `nama_pensiun`, `jenis_kelamin`, `no_ktp_sim`, `no_sk`, `alamat_lengkap`, `tempat_lahir`, `tanggal_lahir`, `no_telepon_pemohon`, `agunan`, `atas_nama_agunan`, `jumlah_tanggungan`, `nama_perusahaan`, `nama_kontak_tidak_serumah`, `hubungan`, `alamat_saudara`, `no_telepon_kontak_tidak_serumah`, `jumlah_permohonan_kredit`, `permohonan_kredit`, `jangka_waktu`, `tujuan_penggunaan`, `account_officer`, `pemohon`, `besaran_gaji`, `dsr`, `angsuran`, `simulation_id`, `deleted_at`, `created_at`, `updated_at`) VALUES
(9, '2025-10-13', 'luthfi', 'Laki-laki', '1111111111111111', '', 'Jalan Cisaranten Kulon', 'Bandung', '0000-00-00', '08979745830', 'SK-Pensiun', '', 0, 'Pensiun', 'wawan', 'Anak Kandung', 'Jalan Pelajar Pejuang', '08979745831', 100000000.00, '', 60, 'Komsumer', 'farid', '', '5000000.00', 40.00, 5833333.33, 9, NULL, '2025-10-12 17:15:51', '2025-10-12 17:15:51'),
(10, '2025-12-31', 'RIAN RIJKI AZHARI', NULL, '1234567890123456', '01.02/2002', 'jalan Antapani no.28', 'Bandung', '1974-02-28', '08979745830', 'SK Pensiun', 'RIAN RIJKI AZHARI', 1, 'Pensiun Guru', 'Siomay', 'saudara', 'Jalan Arcamanik No.60', '08989877777', 100000000.00, 'Pensiun', 36, 'Modal Kerja', 'Muhammad Aria Putra', 'RIAN RIJKI AZHARI', NULL, NULL, NULL, 11, NULL, '2025-12-29 04:29:03', '2025-12-31 01:32:31');

-- --------------------------------------------------------

--
-- Table structure for table `detail_analisa_kredit`
--
...
--
-- Table structure for table `master_debiturs`
--
...
--
-- Dumping data for table `master_debiturs`
--

INSERT INTO `master_debiturs` (`id`, `tanggal`, `nama`, `jenis_kelamin`, `no_ktp_sim`, `masa_berlaku`, `alamat_lengkap`, `tempat_lahir`, `tanggal_lahir`, `pendidikan_terakhir`, `status_rumah`, `lama_menempati`, `status_perkawinan`, `nama_ibu_kandung`, `pekerjaan_ibu_kandung`, `nama_ayah_kandung`, `pekerjaan_ayah_kandung`, `no_telepon_pemohon`, `agunan`, `no_ijasah`, `nama_pasangan`, `no_ktp_sim_pasangan`, `tempat_lahir_pasangan`, `tanggal_lahir_pasangan`, `jumlah_tanggungan`, `pekerjaan_pasangan`, `nama_perusahaan_pasangan`, `nama_perusahaan`, `alamat_perusahaan_pasangan`, `alamat_perusahaan`, `lama_bekerja_pasangan`, `lama_bekerja`, `no_telepon_pasangan`, `no_telepon`, `nama_kontak_tidak_serumah`, `hubungan`, `alamat`, `no_telepon_kontak_tidak_serumah`, `no_id_pegawai`, `bidang_usaha`, `jabatan`, `jumlah_permohonan_kredit`, `jangka_waktu`, `tujuan_penggunaan`, `account_officer`, `besaran_gaji`, `dsr`, `angsuran`, `id_simulation`, `deleted_at`, `created_at`, `updated_at`) VALUES
...
(10, '2025-11-24', 'luthfi', '1990-11-24', 35, 5000000.00, 20.00, 1000000.00, 100000000.00, 24, 20.00, 34.65, 5833333.33, 833333.33, 0.00, 0.00, 3000000.00, 0.00, 36000.00, 5833333.33, 20000.00, 0.00, 1600000.00, 0.00, 0.00, 0.00, 89510666.67, NULL, '2025-11-23 23:26:37', '2025-11-23 23:26:37', NULL, 'Modal Kerja'),
(11, '2025-12-29', 'RIAN RIJKI AZHARI', '1978-10-17', 51, 5000000.00, 80.00, 4000000.00, 100000000.00, 35, 12.00, 21.24, 3857142.86, 1142857.14, 0.00, 0.00, 3000000.00, 2320000.00, 3600000.00, 3857142.86, 2000000.00, 23.20, 0.00, 0.00, 0.00, 0.00, 85222857.14, '2026-01-29', '2025-12-28 23:53:54', '2026-01-07 06:14:58', NULL, 'Pensiun'),
(12, '2026-01-02', 'Asep Ujang', '1976-01-15', 49, 4500000.00, 60.00, 2925000.00, 50000000.00, 36, 14.00, 21.57, 2583333.33, 1916666.67, 0.00, 0.00, 1500000.00, 637500.00, 36000.00, 0.00, 20000.00, 12.75, 800000.00, 0.00, 0.00, 0.00, 44423166.67, '2026-02-02', '2026-01-02 00:58:04', '2026-01-07 05:48:20', NULL, 'Modal Kerja');

-- --------------------------------------------------------

--
-- Table structure for table `table_counts`
--
...
--
-- Dumping data for table `table_counts`
--
...
--
-- Table structure for table `table_counts_copy1`
--
...
--
-- Dumping data for table `table_counts_copy1`
--
...
--
-- Indexes for table `analisa_kredit`
--
...
--
-- Indexes for table `debitur_modal_kerja`
--
...
--
-- Indexes for table `debitur_pensiun`
--
ALTER TABLE `debitur_pensiun`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `detail_analisa_kredit`
--
...
--
-- Indexes for table `master_debiturs`
--
...
--
-- Indexes for table `setting_params`
--
...
--
-- Indexes for table `table_counts`
--
ALTER TABLE `table_counts`
  ADD PRIMARY KEY (`age`) USING BTREE;

--
-- Indexes for table `table_counts_copy1`
--
...
--
-- AUTO_INCREMENT for table `analisa_kredit`
--
ALTER TABLE `analisa_kredit`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `debitur_modal_kerja`
--
ALTER TABLE `debitur_modal_kerja`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `debitur_pensiun`
--
ALTER TABLE `debitur_pensiun`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `detail_analisa_kredit`
--
ALTER TABLE `detail_analisa_kredit`
...
--
-- AUTO_INCREMENT for table `master_debiturs`
--
ALTER TABLE `master_debiturs`
...
--
-- AUTO_INCREMENT for table `nomor_urut`
--
ALTER TABLE `nomor_urut`
...
--
-- AUTO_INCREMENT for table `setting_params`
--
ALTER TABLE `setting_params`
...
--
-- Constraints for table `detail_analisa_kredit`
--
ALTER TABLE `detail_analisa_kredit`
