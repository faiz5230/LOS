...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 13 Okt 2025 pada 05.31
...
(3, '3278030708800020', 'Fitra Ramdani, ST', 'Pejabat Eksekutif Kredit', 'PERJANJIAN KREDIT', 'Jalan Terusan Kopo No. 456 D Kabupaten Bandung', '2023-12-28 21:09:57', '2023-12-28 23:11:43'),
...
CREATE TABLE `master_debiturs` (
  ...
  `id_simulation` bigint DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC;
...
(12, '2024_01_03_033519_create_detail_analisa_kredit', 7);
...
CREATE TABLE `nomor_urut` (
  ...
  `tahun` year NOT NULL,
  `id_debitur` bigint DEFAULT NULL,
...
(1, 'dsr', '40', NULL, NULL),
(2, 'biaya_provisi', '0.005', NULL, NULL),
(3, 'biaya_materai', '36000', NULL, NULL),
(4, 'tabungan_wajib', '10000', NULL, NULL),
(5, 'ass_krd', '300000', NULL, NULL),
(6, 'biaya_administrasi', '0.015', NULL, NULL);
