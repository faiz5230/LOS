...
class SuratKuasa implements FromView,WithStyles,WithDrawings 
{
    /**
    ...
    */
    ...
    public function view(): View
    {
        ...
        if ($this->jenis === 'pensiun') {
            ...
            return view('debitur.pensiun.pensiun.surat_kuasa_export', [
                'debitur' => $debitur
            ]);
        }
        ...
        if ($this->jenis === 'modal_kerja') {
            ...
            return view('debiturs.surat_kuasa_export', [
                'debitur' => $debitur
            ]);
        }
        ...
        if ($debitur) {
            return view('debiturs.surat_kuasa_export', compact('debitur'));
        }

        $debitur = DebiturPensiun::with('simulation')->findOrFail($this->id);
        return view('debiturs.pensiun.surat_kuasa_export', compact('debitur'));
    }
