...
class DataDebiturPensiun implements FromView, WithStyles, WithDrawings 
{
    protected $id;
    ...
    public function view(): View
    {
        ...
        return view('exports.data_debitur_pensiun', [
            'debitur' => $debitur
        ]);
    }
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        for ($row = 1; $row <= $highestRow; $row++) {
            ...
            if (in_array($cellValue, ['DATA PENSIUN', 'DATA SAUDARA YANG TIDAK SERUMAH', 'PERMOHONAN KREDIT'])) {
                $dataRows[] = $row;
